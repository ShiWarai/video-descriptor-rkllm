...
void test_registry_aliases_not_duplicated()
{
    ...
    expect(*resolved == "qwen3.5-2b", "alias 2b should map to 2b model id");
...
void test_config_frame_budget_and_models()
{
    const std::string json = R"({
      ...
      "models": [
        {"id": "qwen3.5-0.8b", "vision_model": "v.rknn", "llm_model": "l.rkllm",
         "temperature": 0.7, "top_k": 20, "top_p": 0.8, "presence_penalty": 1.5},
        {"id": "qwen3.5-2b", "vision_model": "v2.rknn", "llm_model": "l2.rkllm", "preload": true}
      ],
      "pipeline": {
        "frame_budget": 28,
    ...
    expect(*cfg.preload_model_id == "qwen3.5-2b", "preload model id");
    ...
    const auto* m08 = cfg.registry.find("qwen3.5-0.8b");
